...
async function main() {
    ...
    const XYZ = "0x383518188c0c6d7730d91b2c03a03c837814a899";
    ...
    const CVXBond = await ethers.getContractFactory('XYZDAOCVXBondDepository');

    // Deploy CVX bond
    const cvxBond = await CVXBond.deploy(XYZ, CVX, Treasury, DAO);
