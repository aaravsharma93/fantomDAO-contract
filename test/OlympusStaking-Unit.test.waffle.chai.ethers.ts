...
describe('XYZDAO Staking', () => {
    ...
    beforeEach(async () => {
        ...
        OLY = await ethers.getContractFactory('XYZDAOERC20TOken');
        oly = await OLY.deploy();

        Staking = await ethers.getContractFactory('XYZDAOStaking');
        ...
        sOLY = await ethers.getContractFactory('sXYZDAO');
