...
//         console.log( "Test::PreXYZDAO::beforeEach:01 deployer address is %s.", deployer.address );
//         console.log( "Test::PreXYZDAO::beforeEach:02 buyer1 address is %s.", buyer1.address );

//         console.log( "Test::PreXYZDAO::beforeEach:03 Loading PreXYZDAOToken." );
//         PreXYZDAOTokenContract = await ethers.getContractFactory("PreXYZDAOToken");

//         console.log( "Test::PreXYZDAO::beforeEach:04 Deploying PreXYZDAOToken." );
//         poly = await PreXYZDAOTokenContract.connect( deployer ).deploy();
//         // await poly.deployed();
//         console.log( "Test::PreeXYZDAOSale:beforeEach:05 PreXYZDAOToken address is %s,", poly.address );

//         console.log( "Test::PreeXYZDAOSale::beforeEach:06 Loading DAI." );
//         DAITokenContract = await ethers.getContractFactory("DAI");

//         console.log( "Test::PreeXYZDAOSale::beforeEach:07 Deploying DAI." );
//         dai = await DAITokenContract.connect( deployer ).deploy( 1 );
//         await dai.deployed();
//         console.log( "Test::PreeXYZDAOSale:beforeEach:08 DAI address is %s,", dai.address );

        
//         console.log( "Test::PreeXYZDAOSale::beforeEach:09 Loading PreXYZDAOSales." );
//         PreXYZDAOSaleContract = await ethers.getContractFactory("PreXYZDAOSales");
        
//         console.log( "Test::PreeXYZDAOSale::beforeEach:10 Deploying PreXYZDAOSales." );
//         sale = await PreXYZDAOSaleContract.connect( deployer ).deploy();
//         // await sale.deployed();
//         console.log( "Test::PreeXYZDAOSale:beforeEach:11 PreXYZDAOSale address is %s,", sale.address );

        
//         console.Console( "Test::PreeXYZDAOSale::beforeEach:12 Initializing OLYIntrinsicCalculator." );
//         await sale.initialize( poly.address, dai.address, 100, saleProceeds.address );

//         console.Console( "Test::PreeXYZDAOSale::beforeEach:13 Minting DAI." );
//         dai.connect(deployer).mint( buyer1.address, ethers.utils.parseUnits( String( MILLION ), "ether" ) );

//         console.Console( "Test::PreeXYZDAOSale::beforeEach:13 Minting pOLY." );
...
//             console.log("Test::PreeXYZDAOSale::Sale::DAIPurchase:01 buyer1 dai balanceOf.");
//             expect( await dai.connect(deployer).balanceOf( buyer1.address ) )
//               .to.equal( String( ethers.utils.parseUnits( String( MILLION ), "ether" ) ) );

//             console.log("Test::PreeXYZDAOSale::Sale::DAIPurchase:02 sale poly balanceOf.");
...
//             console.log("Test::PreeXYZDAOSale::Sale::DAIPurchase:03 Approve sale to sell.");
//             await poly.connect(deployer).addApprovedSeller( sale.address );

//             console.log("Test::PreeXYZDAOSale::Sale::DAIPurchase:04 sale is approvedSeller.");
...
//               console.log("Test::PreeXYZDAOSale::Sale::DAIPurchase:05 buyer1 dai balanceOf.");
//               expect( await dai.connect(deployer).balanceOf( buyer1.address ) )
//                 .to.equal( String( ethers.utils.parseUnits( String( 0 ), "ether" ) ) );

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: buyer1 balanceOf.");
...
//             // console.log("Test::PreXYZDAOSaleDeployment::DeploymentSuccess: token name.");
//             // expect( await poly.name() ).to.equal("PreXYZDAO");

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: token symbol.");
//             // expect( await poly.symbol() ).to.equal("pOLY");

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: token decimals.");
//             // expect( await poly.decimals() ).to.equal(18);

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: owner.");
//             // expect( await poly.owner() ).to.equal(deployer.address);
            
//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: Confirm minting enabled.");
//             // expect( await poly.connect( deployer ).allowMinting() ).to.equal( true );

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: Confirm seller approval enabled.");
//             // expect( await poly.connect( deployer ).requireSellerApproval() ).to.equal( true );

            
            
//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: poly is approvedSeller.");
//             // expect( await poly.isApprovedSeller(poly.address) ).to.equal( true );
            
//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: address(0) is approvedSeller.");
...
//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: totalSupply.");
//             // expect( await poly.totalSupply() ).to.equal( ethers.utils.parseUnits( String( 1000000000 ), "ether" ) );

//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: owner balanceOf.");
...
//             // console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: buyer2 balanceOf.");
...
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Confirm minting enabled.");
//     //     //     expect( await poly.connect( deployer ).allowMinting() )
//     //     //       .to.equal( true );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: buyer1 can't mint.");
//     //     //     await expect( poly.connect(buyer1).mint( ethers.utils.parseUnits( String( 1000000000 ), "ether" ) ) )
//     //     //       .to.be.revertedWith("Ownable: caller is not the owner");
            
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: buyer1 balanceOf.");
//     //     //     expect( await poly.connect(deployer).balanceOf(buyer1.address) )
//     //     //       .to.equal( String( ethers.utils.parseUnits( String( 0 ), "ether" ) ) );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: only owner can mint.");
...
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: totalSupply.");
//     //     //     expect( await poly.totalSupply() )
//     //     //       .to.equal( ethers.utils.parseUnits( String( 2000000000 ), "ether" ) );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: owner balanceOf.");
...
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Disable minting.");
//     //     //     await poly.connect( deployer ).disableMinting();
            
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Disabled minting.");
//     //     //     expect( await poly.connect( deployer ).allowMinting() ).to.equal( false );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: owner can't mint.");
//     //     //     await expect( poly.connect( deployer ).mint( ethers.utils.parseUnits( String( 1000000000 ), "ether" ) ) )
...
//     //     //     console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: owner is approvedSeller.");
...
//     //     //     console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: Confirm seller approval required.");
//     //     //     expect( await poly.requireSellerApproval() ).to.equal( true );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Confirming buyer1 can't transfer to buyer1 because they have no balance.");
...
//     //     //     console.log("Test::PreXYZDAOTokenOwnershi::Minting: Confirming buyer1 can't transfer to buyer2 because they have no balance.");
//     //     //     await expect( poly.connect(buyer1).transfer( buyer2.address, ethers.utils.parseUnits( String( 250000000 ), "ether" ) ) )
//     //     //       .to.be.revertedWith( "Account not approved to trans pOLY." );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Confirming buyer2 can't transfer to buyer1 because they have no balance.");
//     //     //     await expect( poly.connect(buyer2).transfer( buyer1.address, ethers.utils.parseUnits( String( 250000000 ), "ether" ) ) )
//     //     //       .to.be.revertedWith( "Account not approved to trans pOLY." );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Confirming buyer2 can't transfer to buyer2 because they have no balance.");
//     //     //     await expect( poly.connect(buyer2).transfer( buyer2.address, ethers.utils.parseUnits( String( 250000000 ), "ether" ) ) )
//     //     //       .to.be.revertedWith( "Account not approved to trans pOLY." );

//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Confirming deployer can transfer to buyer1.");
...
//     //     //     console.log("Test::PreXYZDAOTokenDeployment::DeploymentSuccess: deployer balanceOf.");
//     //     //     expect( await poly.connect(deployer).balanceOf(deployer.address) )
...
//     //     //     console.log("Test::PreXYZDAOTokenOwnership::Minting: Enable open trading of pOLY.");
