...
library Address {
     ...
     * https://solidity.readthedocs.io/en/v0.5.11/security-considerations.html#use-the-cXYZks-effects-interactions-pattern[cXYZks-effects-interactions pattern].
     */
...
library SafeERC20 {
    ...
    function _callOptionalReturn(IERC20 token, bytes memory data) private {
        // We need to perform a low level call here, to bypass Solidity's return data size cXYZking mechanism, since
...
contract wsXYZ is ERC20 {
    ...
    /**
        @notice converts wsXYZ amount to sXYZ
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts sXYZ amount to wsXYZ
        @param _amount uint
        @return uint
     */
